...
import { Faqs, PaymentScreen, ProfileScreen, SettingsScreen,Help,LogOut,HistoryCommands, HomeScreen, LoginScreen } from '../screens';
            ...
            return(
                <SafeAreaView>
                    ...
                    <View style={{
                       ...
                       <Image source={require("../assets/images/sky.jpg")}
                       style={{
                        height:150,
                        width:150,
                        borderRadius:80,
                    ...
                    <Text style={{fontSize:16,fontWeight:"bold", color:'black',  marginLeft:'42%'}}>
                        UserName
                    </Text>
                    <Text style={{fontSize:16, color:'gray',marginLeft:'30%'}}>dtakouessa@gmail.com</Text>
                    </View>
                     {/* Drawer items */}
                    <View>
